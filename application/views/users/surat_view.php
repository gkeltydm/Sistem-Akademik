...
<div class="card mb-3">
    <div class="card-header">
        <h4>1. Surat Keterangan Aktif Kuliah
            ...
            <a href="<?= base_url('users/surat/download_template/' . urlencode(url_title('surat_keterangan_aktif_kuliah'))); ?>" class="btn btn-success float-end">
...
<div class="card mb-3">
    <div class="card-header">
        <h4>2. Surat Keterangan Berkelakuan Baik
            <!-- Tombol Download Template -->
            <a href="<?= base_url('users/surat/download_template/' . urlencode(url_title('surat_keterangan_berkelakuan_baik'))); ?>" class="btn btn-success float-end">
            <i class="fa-solid fa-download"></i>
        </a>
        </h4>
    </div>
...
<div class="card mb-3">
    <div class="card-header">
        <h4>3. Surat Rekomendasi Beasiswa
            <!-- Tombol Download Template -->
        <a href="<?= base_url('users/surat/download_template/' . urlencode(url_title('surat_rekomendasi_beasiswa'))); ?>" class="btn btn-success float-end">
            <i class="fa-solid fa-download"></i>
        </a>
        </h4>
    </div>
