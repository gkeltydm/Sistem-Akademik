...
<i class="fa-solid fa-university"></i> Dosen
</div>
...
<tr>
    ...
    <td width = 20px><?php echo anchor('administrator/dosen/detail/' .$dsn->nidn, '<div class="btn btn-sm btn-primary"><i class = "fa fa-eye"> </i></div>') ?></td>
