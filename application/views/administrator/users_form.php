...
<i class="fa-solid fa-university"></i> Form Tambah Users
</div>
...
<form method="post" action="<?php echo base_url('administrator/users/tambah_users_aksi') ?>">
    ...
    <div class="form-group">
        <label>NIM (JIKA USER UNTUK ADMIN KOSONG KAN SAJA / JIKA USER MAHASISWA MASUKKAN NIM)</label>
        <input type="text" name="nim" placeholder= "HANYA UNTUK MAHASISWA/USER BUKAN ADMIN" class="form-control">
    </div>
