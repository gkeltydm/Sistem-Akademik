...
<div class="container-fluid">
    ...
    ?>
    <div class="alert alert-danger">Maaf, kode mata kuliah yang anda input <strong>TIDAK TERSEDIA!</strong> di tahun ajaran <?php echo $thn->tahun_akademik . "(" .$tampilSemester . ")"; ?></div>
   ...
   ?>
    ...
    <table class="table table-striped table-hover table-bordered mt-4">
        ...
        <tr>
            ...
            <input type="hidden" name="id_krs[]" value="<?php echo $row->id_krs; ?>" id="">
