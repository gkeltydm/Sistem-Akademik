...
class Krs extends CI_Controller{
    ...
    public function tambah_krs($nim, $thn_akad){
        $tahun_akademik_obj = $this->tahunakademik_model->get_by_id($thn_akad);
        $data = array(
            'id_krs' => set_value('id_krs'),
            'id_thn_akad' => $thn_akad,
            'thn_akad_smt' => $tahun_akademik_obj->tahun_akademik,
            'semester' => $tahun_akademik_obj->semester == 1 ? 'Ganjil' : 'Genap',
            'nim' => $nim,
...
public function update_aksi () {
    ...
    $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
                Data KRS Berhasil Diupdate! <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
               </div>');
                redirect('administrator/krs/index');
...
public function delete($id){
    ...
    $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    Data KRS Berhasil Dihapus! <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   </div>');
    redirect('administrator/krs/index');
}
